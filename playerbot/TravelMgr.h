...
namespace ai
{
    ...
    public:
        ...
        WorldPosition operator+(const WorldPosition& p1) { WorldPosition p(*this); p += p1; return p; }
        WorldPosition operator-(const WorldPosition& p1) { WorldPosition p(*this); p -= p1; return p; }

        WorldPosition operator*(const float s) { WorldPosition p(*this); p *= s; return p; }
        WorldPosition operator/(const float s) { WorldPosition p(*this); p /= s; return p; }

...
bool PlayerbotAIConfig::Initialize()
{
    ...
    randomBotsLoginSpeed = config.GetFloatDefault("AiPlayerbot.RandomBotsLoginSpeed", 1.0f);
    ...
    guildFeedback = config.GetBoolDefault("AiPlayerbot.GuildFeedback", true);
    
    randomBotFormGuild = config.GetBoolDefault("AiPlayerbot.RandomBotFormGuild", true);
    
    boostFollow = config.GetBoolDefault("AiPlayerbot.BoostFollow", true);

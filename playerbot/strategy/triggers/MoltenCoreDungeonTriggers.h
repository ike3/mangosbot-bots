...
namespace ai
{
    ...
    class MagmadarLavaBombTrigger : public CloseToGameObjectHazard
    {
    public:
        MagmadarLavaBombTrigger(PlayerbotAI* ai) : CloseToGameObjectHazard(ai, "magmadar lava bomb", 177704, 5.0f, 60) {}
    };

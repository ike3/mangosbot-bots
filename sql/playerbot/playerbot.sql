...
INSERT INTO `ai_playerbot_texts` (`id`, `name`, `text`, `say_type`, `reply_type`, `text_loc1`, `text_loc2`, `text_loc3`, `text_loc4`, `text_loc5`, `text_loc6`, `text_loc7`, `text_loc8`) VALUES
	...
	(138, 'suggest_something', 'Looking for gold.', 0, 0, '', 'A la recherche de l\'or.', '', '', '', '', '', 'Ищу голд.'),
	...
	(210, 'reply', 'what was that %s?', 0, 0, '', '', '', '', '', '', '', ''),
	(211, 'reply', 'not sure I understand %s?', 0, 0, '', '', '', '', '', '', '', ''),
	(212, 'reply', 'uh... no clue what yer talkin bout', 0, 0, '', '', '', '', '', '', '', ''),
	(213, 'reply', 'you talkin to me %s?', 0, 0, '', '', '', '', '', '', '', ''),
	(214, 'reply', 'whaaaa?', 0, 0, '', '', '', '', '', '', '', ''),
	(215, 'reply', 'huh?', 0, 0, '', '', '', '', '', '', '', ''),
	(216, 'reply', 'what?', 0, 0, '', '', '', '', '', '', '', ''),
	(217, 'reply', 'are you talking?', 0, 0, '', '', '', '', '', '', '', ''),
	(218, 'reply', 'whatever dude', 0, 0, '', '', '', '', '', '', '', ''),
	(219, 'reply', 'you lost me', 0, 0, '', '', '', '', '', '', '', ''),
	(220, 'reply', 'Bla bla bla...', 0, 0, '', '', '', '', '', '', '', ''),
	(221, 'reply', 'What did you say, %s?', 0, 0, '', '', '', '', '', '', '', ''),
	(222, 'reply', 'Concentrate on the game, %s!', 0, 0, '', '', '', '', '', '', '', ''),
	(223, 'reply', 'Chatting with you %s is so great! I always wanted to meet you', 0, 0, '', '', '', '', '', '', '', ''),
	(224, 'reply', 'These chat-messages are freaking me out! I feel like I know you all!', 0, 0, '', '', '', '', '', '', '', ''),
	(225, 'reply', 'YEAH RIGHT! HAHA SURE!!!', 0, 0, '', '', '', '', '', '', '', ''),
	(226, 'reply', 'I believe you!!!', 0, 0, '', '', '', '', '', '', '', ''),
	(227, 'reply', 'OK, uhuh LOL', 0, 0, '', '', '', '', '', '', '', ''),
	(228, 'reply', 'Why is everybody always saying the same things???', 0, 0, '', '', '', '', '', '', '', ''),
	(229, 'reply', 'Hey %s....oh nevermind!', 0, 0, '', '', '', '', '', '', '', ''),
	(230, 'reply', 'What are you talking about %s', 0, 0, '', '', '', '', '', '', '', ''),
	(231, 'reply', 'Who said that? I resemble that remark', 0, 0, '', '', '', '', '', '', '', ''),
	(232, 'reply', 'hey %s i havent forgotten you', 0, 1, '', '', '', '', '', '', '', ''),
	(233, 'reply', 'you piss me off %s', 0, 1, '', '', '', '', '', '', '', ''),
	(234, 'reply', 'im gunna get you this time %s', 0, 1, '', '', '', '', '', '', '', ''),
	(235, 'reply', 'better watch your back %s', 0, 1, '', '', '', '', '', '', '', ''),
	(236, 'reply', 'i did not like last round so much', 0, 1, '', '', '', '', '', '', '', ''),
	(237, 'reply', 'i sucked last round thanks to %s', 0, 1, '', '', '', '', '', '', '', ''),
	(238, 'reply', 'prepare to die %s', 0, 1, '', '', '', '', '', '', '', ''),
	(239, 'reply', 'dont appreciate you killin me %s', 0, 1, '', '', '', '', '', '', '', ''),
	(240, 'reply', '%s, i hate you', 0, 1, '', '', '', '', '', '', '', ''),
	(241, 'reply', 'grrrrrr, ill get you this time %s', 0, 1, '', '', '', '', '', '', '', ''),
	(242, 'reply', 'well fuck you', 0, 1, '', '', '', '', '', '', '', ''),
	(243, 'reply', 'wtf', 0, 2, '', '', '', '', '', '', '', ''),
	(244, 'reply', 'wtf??', 0, 2, '', '', '', '', '', '', '', ''),
	(245, 'reply', 'low life', 0, 2, '', '', '', '', '', '', '', ''),
	(246, 'reply', 'wth', 0, 2, '', '', '', '', '', '', '', ''),
	(247, 'reply', 'sucked', 0, 2, '', '', '', '', '', '', '', ''),
	(248, 'reply', 'REMATCH!!! im taking him down', 0, 2, '', '', '', '', '', '', '', ''),
	(249, 'reply', 'pathetic, i got killed by %s', 0, 2, '', '', '', '', '', '', '', ''),
	(250, 'reply', 'hehe, i nailed %s?', 0, 3, '', '', '', '', '', '', '', ''),
	(251, 'reply', 'that was too easy, killin %s', 0, 3, '', '', '', '', '', '', '', ''),
	(252, 'reply', 'gotcha mofo', 0, 3, '', '', '', '', '', '', '', ''),
	(253, 'reply', 'ha ha', 0, 3, '', '', '', '', '', '', '', ''),
	(254, 'reply', 'loser', 0, 3, '', '', '', '', '', '', '', ''),
	(255, 'reply', 'i killed %s and yer all next dudes', 0, 3, '', '', '', '', '', '', '', ''),
	(256, 'reply', 'oh yeah i owned him', 0, 3, '', '', '', '', '', '', '', ''),
	(257, 'reply', 'im a killin machine', 0, 3, '', '', '', '', '', '', '', ''),
	(258, 'reply', '%s,  this reminds me of a Slayer song...all this bloodshed', 0, 3, '', '', '', '', '', '', '', ''),
	(259, 'reply', 'sorry, %s. can we do the scene again?', 0, 3, '', '', '', '', '', '', '', ''),
	(260, 'reply', 'so....how do you like being worm food %s???', 0, 3, '', '', '', '', '', '', '', ''),
	(261, 'reply', 'yer supposed to be dead, %s its part of the game!!!!!', 0, 3, '', '', '', '', '', '', '', ''),
	(262, 'reply', 'sorry, %s. that looked as good as an Andy Worhol painting!', 0, 3, '', '', '', '', '', '', '', ''),
	(263, 'reply', '%s, ill use the rubber bullets next time !', 0, 3, '', '', '', '', '', '', '', ''),
	(264, 'reply', 'whatsamatter, %s?? lose your head? hahaha gotta keep cool!!', 0, 3, '', '', '', '', '', '', '', ''),
	(265, 'reply', 'i had to do it, %s. You understand. The Director said so!!', 0, 3, '', '', '', '', '', '', '', ''),
	(266, 'reply', 'hey %s.......MUAHAHAHAHAHAHAHAHAHAHA', 0, 3, '', '', '', '', '', '', '', ''),
	(267, 'reply', '%s, i enjoyed that one!! Lets play it again Sam', 0, 3, '', '', '', '', '', '', '', ''),
	(268, 'reply', 'hey, %s! ju can start callin me scarface.. ju piece of CHIT!!!!', 0, 3, '', '', '', '', '', '', '', ''),
	(269, 'reply', 'are you talking to me %s??', 0, 3, '', '', '', '', '', '', '', ''),
	(270, 'reply', '%s get it right this time, dont stand in front of my bullets.', 0, 3, '', '', '', '', '', '', '', ''),
	(271, 'reply', '%s, what are you laying around for??? hehe', 0, 3, '', '', '', '', '', '', '', ''),
	(272, 'reply', 'hi %s', 0, 4, '', '', '', '', '', '', '', ''),
	(273, 'reply', 'oh, hi %s', 0, 4, '', '', '', '', '', '', '', ''),
	(274, 'reply', 'wazzup %s!!!', 0, 4, '', '', '', '', '', '', '', ''),
	(275, 'reply', 'hi', 0, 4, '', '', '', '', '', '', '', ''),
	(276, 'reply', 'wazzup', 0, 4, '', '', '', '', '', '', '', ''),
	(277, 'reply', 'hello %s', 0, 4, '', '', '', '', '', '', '', ''),
	(278, 'reply', 'hi %s, do i know you?', 0, 4, '', '', '', '', '', '', '', ''),
	(279, 'reply', 'hey %s', 0, 4, '', '', '', '', '', '', '', ''),
	(280, 'reply', 'hai %s', 0, 4, '', '', '', '', '', '', '', ''),
	(281, 'reply', 'wth', 0, 6, '', '', '', '', '', '', '', ''),
	(282, 'reply', 'wtf', 0, 6, '', '', '', '', '', '', '', ''),
	(283, 'reply', 'this is bs', 0, 6, '', '', '', '', '', '', '', ''),
	(284, 'reply', 'admin', 0, 6, '', '', '', '', '', '', '', ''),
	(285, 'reply', 'hey %s quit abusing your admin', 0, 6, '', '', '', '', '', '', '', ''),
	(286, 'reply', 'leave me alone admin!', 0, 6, '', '', '', '', '', '', '', ''),
	(287, 'reply', 'you suck admin', 0, 6, '', '', '', '', '', '', '', ''),
	(288, 'reply', 'thats my name, what you want %s', 0, 5, '', '', '', '', '', '', '', ''),
	(289, 'reply', 'yes???', 0, 5, '', '', '', '', '', '', '', ''),
	(290, 'reply', 'uh... what', 0, 5, '', '', '', '', '', '', '', ''),
	(291, 'reply', 'you talkin to me %s?', 0, 5, '', '', '', '', '', '', '', ''),
